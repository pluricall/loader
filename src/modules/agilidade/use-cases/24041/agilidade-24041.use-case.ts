...
export class Agilidade24041UseCase {
  ...
  async execute({
    ...
    await this.agilidadeRepository.insertAtLeadsRepository({
      ...
      createdDate: bodyRequest.dataEntrada || "",
      postedDate: bodyRequest.dataPedido || "",
    ...
    this.agilidade24041UploadContacts.execute({
      ...
      created_date: bodyRequest.dataEntrada || "",
      ad_name: bodyRequest.horario || "",
      campaign_name: bodyRequest.dataPedido || "",
